...
const BackGroundCircles = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="rounded-full absolute border border-[#333333]] opacity-20  h-[650px] w-[650px] mt-52 animate-pulse" />
      <div className="rounded-full absolute border border-[#333333] opacity-20  h-[800px] w-[800px] mt-52 animate-pulse" />
    </motion.div>
  );
};
